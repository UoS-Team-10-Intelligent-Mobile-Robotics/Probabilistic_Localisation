...
This is the repository for the first series of Practical sessions (P4 to P5) of the Intelligent Mobile Robotics module. The repository is designed around the build from the module.
